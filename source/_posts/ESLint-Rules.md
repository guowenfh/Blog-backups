...
>
> [本文个人博客地址](//guowenfh.github.io/2016/08/07/ESLint-Rules/)



在很久之前就想通过工具来规范自己的代码风格，减少程序出错的概率，如果看过我的[一个前端程序猿的Sublime Text3的自我修养](//guowenfh.github.io/2015/12/26/SublimeText/)，这篇博客的朋友，肯定知道在当时我使用`SublimeLinter-jshint`插件来规范风格，但是实际上一直懒癌发作也没去看它的文档，使用着它默认的规则。不过现在是时候切换到 ESLint 了！
