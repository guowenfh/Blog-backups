...
> 建议把所有的实例在console窗口敲一遍.例子中展现的只是一部分,配合《正则表达式-理论基础篇》[SF地址](http://segmentfault.com/a/1190000003977848)、[原址](https://guowenfh.github.io/2015/12/01/Regexp-basis/)使用效果更佳哦!
